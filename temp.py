...
if __name__ == "__main__":
    ...
    params = {
        "model": cVAE,
        "path_to_deterministic" : '/space/hall7/sitestore/eccc/crd/cccma/users/rpg002/output/SI/Full/results/NOAA/UNet2/run_set_final_convnext/N2_M12_VAL3_F12_v1.1_North_lr0.0001_batch25x1_e100_equalweights_NPSproj_cosine_lr_scheduler_bilinear', 
        "freeze_deterministic" : True,
        "learn_decoder_variance" : dict( status= False,  offline = True, epochs = 100), 
        'learn_decoder_sampler' : dict( status= True,  noise_std =1, decoder_sample_size = 10, noise_injection_level = 'medium'), 
