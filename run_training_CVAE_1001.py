...
from models.cvae_1031 import cVAE  #originally should be cvae_1001
...
if __name__ == "__main__":
    ...
    params = {
        "model": cVAE,
        "path_to_deterministic" :'/space/hall7/sitestore/eccc/crd/cccma/users/rpg002/output/SI/Full/results/NASA/UNet2/run_set_final_convnext/N2_M12_VAL3_F12_v1.1_North_lr0.001_batch25x1_e100_equalweights_NPSproj_cosine_lr_scheduler_bilinear', 
    ...
    out_dir_x  = f'/space/hall7/sitestore/eccc/crd/cccma/users/rpg002/output/SI/Full/results/{obs_ref}/{params["model"].__name__}/run_set_4_convnext'  
    ...
    if params['learn_decoder_sampler']['status']:
        ...
        model_type = model_type + f'-DecoderSamplerV31-{params["learn_decoder_sampler"]["decoder_sample_size"]}-{params["learn_decoder_sampler"]["noise_injection_level"]}'  ## originally should be DecoderSamplerV01 but snce the model is v31
